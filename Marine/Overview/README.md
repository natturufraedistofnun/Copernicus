...
Hún notar Python til að sækja sjálfvirkt lýsingar um gangasettin og búa til markdown skjöl. Svo er hægt að skóða gagnasett beint í kóða. 


### Leiðbeiningar
1. Opnaðu vinnubókina í Google Colab eða annarri skýjaþjónustu.
2. Slá inn gildum aðgangsupplýsingum.
